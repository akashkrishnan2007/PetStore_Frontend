        ...
        <div className="row justify-content-center">
          <div className="col-xl-5 col-lg-6 col-md-8 col-sm-10">
            <div className="auth-card">
              ...
              <h2 style={{ textAlign: 'center', fontSize: '1.5rem' }}>Create Your PetZone Account</h2>
              <p className="auth-sub">Join PetZone to adopt pets, shop pet products, connect with trusted sellers, and become part of our pet-loving community.</p>
